...
while time_passed < 4_000_000: 
	...
	fl_angle_a = getSineAngle(time_passed, 135, 225, 180, 25) #(lower angle, upper angle, start angle, %speed)
	fr_angle_a = getSineAngle(time_passed, 135, 225, 135, 25)
	bl_angle_a = getSineAngle(time_passed, 135, 225, 225, 25)
	br_angle_a = getSineAngle(time_passed, 135, 225, 180, 25)
	
	fl_angle_b = getSineAngle(time_passed, 150, 190, 190, 25)
	mid = (190 - 150) / 2
