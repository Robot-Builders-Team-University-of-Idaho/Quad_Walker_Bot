...
class servo:
	...
	def enableTorque(self) -> bool:
		result, error = packet_handler.write1ByteTxRx(port_handler, self.id, addr_torque, 1)
	...
	def disableTorque(self) -> bool:
		result, error = packet_handler.write1ByteTxRx(port_handler, self.id, addr_torque, 0)
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
	...
	def torqueOn(self) -> bool:
		value, result, error = packet_handler.read1ByteTxRx(port_handler, self.id, addr_torque)
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
	...
	def setAngle(self, angle: float) -> bool:
		result, error = packet_handler.write4ByteTxRx(port_handler, self.id, addr_goal_pos, angleToPos(angle))
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
	...
	def setPos(self, pos: int) -> bool:
		result, error = packet_handler.write4ByteTxRx(port_handler, self.id, addr_goal_pos, pos)
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
	...
	def getAngle(self):
		current_position, result, error = packet_handler.read4ByteTxRx(port_handler, self.id, addr_curr_pos)
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
	...
	def setVel(self, vel: int) -> bool:
		result, error = packet_handler.write4ByteTxRx(port_handler, self.id, addr_goal_vel, vel)
		if result != COMM_SUCCESS:
			print("%s" % packet_handler.getTxRxResult(result))
			return False
		elif error != 0:
