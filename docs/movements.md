...
$$\frac{upper\_ang - lower\_ang}{2} sin((speed \cdot wave\_len) t + start\_ang\_offset) + \frac{upper\_ang + lower\_ang}{2}$$
...
Equation for sine wave:
$$\frac{upper\_pos - lower\_pos}{2} sin((speed \cdot wave\_len) t + start\_pos\_offset) + \frac{upper\_pos + lower\_pos}{2}$$
